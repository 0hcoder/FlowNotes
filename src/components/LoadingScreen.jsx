...
const LoadingScreen = () => {
  ...
  return (
    <div className="loadings relative w-full h-screen bg-black overflow-hidden">
      ...
      >
        <h1 id="text1" className="text-8xl text-white">Write Your Notes ✍️</h1>
      </div>
      <div
        id="loding2"
      ...
      <div
        id="loding3"
        className="loding scale-0 opacity-0 z-10 bg-white flex items-center justify-center  absolute w-[80%] h-[80vh] top-[50%] left-[50%] -translate-1/2 rounded-4xl overflow-hidden p-3"
      ></div>
    </div>
  );
};
